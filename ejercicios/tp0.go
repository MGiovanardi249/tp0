...
// Devuelve -1 si el primer arreglo es menor que el segundo; 0
// si son iguales; o 1 si el primero es el mayor.
// Un arreglo es menor a otro cuando al compararlos elemento
// a elemento, el primer elemento en el que difieren
...
// Se puede usar una función auxiliar (que sea
// la recursiva).
